...
**Output:** Document validated assumptions in `anamnesis/specs/problem.md` with confidence scores and validation plans.
...
**Output:** Document chosen option with risk assessment in `anamnesis/specs/options.md`.
...
- `anamnesis/specs/problem.md` — Objectives, components, assumptions, validation plans
- `anamnesis/specs/options.md` — Chosen approach, risk assessment, confidence levels
- `anamnesis/specs/requirements.md` — EARS syntax specs with validation criteria
- `anamnesis/specs/tech.md` — Stack, constraints, risk mitigations
...
10. **STOP** and await user confirmation before writing to `anamnesis/specs/tasks.md`.
