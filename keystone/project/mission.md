...
- [ ] Users can initialize a project with a single file copy and a conversation.
- [ ] Existing codebases can be retrofitted with Keystone specs that are cited and verified against source code.
- [ ] Framework updates can be applied without overwriting user customizations in directives.
- [ ] 90%+ confidence in automated project detection and retrofit accuracy.
...
Phase 1: The Initiator & Core Refactor Planning.
